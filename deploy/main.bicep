...
@description('Teh administrator login usernaem for the SQL server. ')
param sqlServerAdministratorLogin string

@secure()
@description('Teh administrator loign password for the SQL server. ')
...
var sqlDatabaseConnectionString = 'Server=tcp:${sqlServer.properties.fullyQualifiedDomainName},1433;Initial Catalog=${sqlDatabase.name};User ID=${sqlServerAdministratorLogin};Password=${sqlServerAdministratorLoginPassword};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'
